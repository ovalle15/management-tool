...
function createData(item, status) {
  return {
    ...
    history: [
      ...
      { reviewed: '2020-01-02', reviewer: 'Tali', comments: 2 },
      { reviewed: '2020-01-03', reviewer: 'Tali', comments: 3 },
      { reviewed: '2020-01-04', reviewer: 'Tali', comments: 4 },
      { reviewed: '2020-01-05', reviewer: 'Tali', comments: 5 },
      { reviewed: '2020-01-06', reviewer: 'Tali', comments: 6 },
      { reviewed: '2020-01-07', reviewer: 'Tali', comments: 7 },
    ],
  };
}
